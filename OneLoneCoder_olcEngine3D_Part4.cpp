...
public:
	bool OnUserCreate() override
	{
		...
		auto& tris = meshCube.tris;

		// SOUTH
		tris.push_back(triangle{vec3d(0.0f, 0.0f, 0.0f), vec3d(0.0f, 1.0f, 0.0f), vec3d(1.0f, 1.0f, 0.0f), vec2d(0.0f, 1.0f), vec2d(0.0f, 0.0f), vec2d(1.0f, 0.0f)});
		tris.push_back(triangle{vec3d(0.0f, 0.0f, 0.0f), vec3d(1.0f, 1.0f, 0.0f), vec3d(1.0f, 0.0f, 0.0f), vec2d(0.0f, 1.0f), vec2d(1.0f, 0.0f), vec2d(1.0f, 1.0f)});
						  																			   
		// EAST           																			   
		tris.push_back(triangle{vec3d(1.0f, 0.0f, 0.0f), vec3d(1.0f, 1.0f, 0.0f), vec3d(1.0f, 1.0f, 1.0f), vec2d(0.0f, 1.0f), vec2d(0.0f, 0.0f), vec2d(1.0f, 0.0f)});
		tris.push_back(triangle{vec3d(1.0f, 0.0f, 0.0f), vec3d(1.0f, 1.0f, 1.0f), vec3d(1.0f, 0.0f, 1.0f), vec2d(0.0f, 1.0f), vec2d(1.0f, 0.0f), vec2d(1.0f, 1.0f)});
						   																			   
		// NORTH           																			   
		tris.push_back(triangle{vec3d(1.0f, 0.0f, 1.0f), vec3d(1.0f, 1.0f, 1.0f), vec3d(0.0f, 1.0f, 1.0f), vec2d(0.0f, 1.0f), vec2d(0.0f, 0.0f), vec2d(1.0f, 0.0f)});
		tris.push_back(triangle{vec3d(1.0f, 0.0f, 1.0f), vec3d(0.0f, 1.0f, 1.0f), vec3d(0.0f, 0.0f, 1.0f), vec2d(0.0f, 1.0f), vec2d(1.0f, 0.0f), vec2d(1.0f, 1.0f)});
						   																			   
		// WEST            																			   
		tris.push_back(triangle{vec3d(0.0f, 0.0f, 1.0f), vec3d(0.0f, 1.0f, 1.0f), vec3d(0.0f, 1.0f, 0.0f), vec2d(0.0f, 1.0f), vec2d(0.0f, 0.0f), vec2d(1.0f, 0.0f)});
		tris.push_back(triangle{vec3d(0.0f, 0.0f, 1.0f), vec3d(0.0f, 1.0f, 0.0f), vec3d(0.0f, 0.0f, 0.0f), vec2d(0.0f, 1.0f), vec2d(1.0f, 0.0f), vec2d(1.0f, 1.0f)});
						   																			   
		// TOP             																			   
		tris.push_back(triangle{vec3d(0.0f, 1.0f, 0.0f), vec3d(0.0f, 1.0f, 1.0f), vec3d(1.0f, 1.0f, 1.0f), vec2d(0.0f, 1.0f), vec2d(0.0f, 0.0f), vec2d(1.0f, 0.0f)});
		tris.push_back(triangle{vec3d(0.0f, 1.0f, 0.0f), vec3d(1.0f, 1.0f, 1.0f), vec3d(1.0f, 1.0f, 0.0f), vec2d(0.0f, 1.0f), vec2d(1.0f, 0.0f), vec2d(1.0f, 1.0f)});
						   																			  
		// BOTTOM          																			  
		tris.push_back(triangle{vec3d(1.0f, 0.0f, 1.0f), vec3d(0.0f, 0.0f, 1.0f), vec3d(0.0f, 0.0f, 0.0f), vec2d(0.0f, 1.0f), vec2d(0.0f, 0.0f), vec2d(1.0f, 0.0f)});
